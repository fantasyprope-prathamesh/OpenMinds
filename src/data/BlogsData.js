const blogsData = [
    {
      ...
      image: "https://source.unsplash.com/m2J105CzEAU",
      description: "Exploring the impact of stress on mental health and practical coping strategies.",
        deepdescription : "Delve into the intricacies of stress, from its physiological impacts on the body to its long-term effects on mental health. Explore practical coping mechanisms, including mindfulness techniques and stress-reducing activities, to build resilience in the face of life's challenges."
    },
    {
        id : 2,
      ...
      image: "https://source.unsplash.com/eMP4sYPJ9x0",
      description: "Discovering how practicing gratitude can positively influence mental well-being.",
        deepdescription : "Uncover the profound effects of gratitude on mental well-being through an in-depth exploration. Learn about gratitude journaling, gratitude practices in different cultures, and scientific studies highlighting its role in fostering a positive mindset and reducing stress."
    },
    {
        id : 3,
