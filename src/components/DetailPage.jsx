    ...
    <>
      ...
      {dynamicBlog && (
          ...
          >
            <div
              className="left-div "
              style={{ width: "50%",overflow: "hidden", display:"flex",alignItems:"center" ,justifyContent:"space-around", marginRight:"1rem" }}
            >
              ...
              <ul>
                ...
                <li>
                  <div>
                    ...
                    <span className="fst-normal fs-6">{dynamicBlog.deepdescription}</span>
                  </div>
                </li>
              </ul>
            </div>
